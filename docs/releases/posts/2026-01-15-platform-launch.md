...
# Thalian platform launch

The Thalian platform is live with support for 15 initial integrations, 79 analysis rules, and AI-powered cross-platform intelligence.

<!-- more -->

## What shipped

- **15 initial integrations** across identity providers, device managers, SaaS apps, and ITSM platforms
